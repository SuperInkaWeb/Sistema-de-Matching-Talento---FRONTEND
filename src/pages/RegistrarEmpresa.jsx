...
export default function RegisterEmpresa() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 409) {
        setError('Ya existe una cuenta registrada con este email. Intenta iniciar sesión.')
        return
      }
        ...
        <div className="register-empresa__card">
          ...
          {step === 'form' && (
            <form onSubmit={handleSubmit} className="register-form">
              ...
              <div className="form-field">
                ...
                {rucInfo && !rucInfo.error && (
                  <div className="ruc-info">
                    ...
                    <p className="ruc-info__name">{rucInfo.nombre || rucInfo.razon_social}</p>
              ...
              <button type="submit" className="register-btn" disabled={loading}>
                {loading ? 'Enviando...' : 'Crear cuenta empresa'}
              </button>
            </form>
          )}
          ...
          {step === 'done' && (
            <div className="register-done">
              ...
              <h3 className="register-done__title">¡Cuenta creada!</h3>
              <p className="register-done__text">
                Tu cuenta empresa está lista. Inicia sesión con el email que registraste.
              </p>
